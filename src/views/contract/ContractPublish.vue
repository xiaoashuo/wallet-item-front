<template>
   <div class="contract-publish">
     ...
     <div class="contract-publish-name contract-item">
       <p>合约名称:</p>
       <p><input type="text" name="name" placeholder="请输入合约名称"></p>
     </div>
     <div class="contract-publish-symbol contract-item">
       <p>合约标志:</p>
       <p><input type="text" name="symbol" placeholder="请输入合约标志"></p>
     </div>
     <div class="contract-publish-decimals contract-item">
       <p>合约精度:</p>
       <p><input type="text" name="decimals" placeholder="请输入合约精度"></p>
     </div>
     <div class="contract-publish-supply contract-item">
       <p>合约发行量:</p>
       <p><input type="text" name="totalSupply" placeholder="请输入总发行量"></p>
     </div>
